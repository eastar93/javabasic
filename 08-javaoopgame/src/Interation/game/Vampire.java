...
public class Vampire {
	...
	public void huntGd(Gladiator Gd)
	{
		...
		if(atk<=Gd.getDef())
		{
			System.out.println("벰파이어는 검투사의 방어력이 높아 데미지를 못입혔습니다.");
			System.out.println("----------------------------------------------");
		}
		else if(Gd.getHp()>0)
		{
			System.out.printf("벰파이어가 검투사에게 %d만큼의 데미지를 주었습니다.%n",getAtk()-Gd.getDef());
			System.out.println("----------------------------------------------");
			Gd.getGdInfo();			
		}
	}
	...
	public void huntDs(DragonSlayer Ds)
	{
		...
		if(atk<=Ds.getDef())
		{
			System.out.println("벰파이어는 드래곤슬레이어의 방어력이 높아 데미지를 못입혔습니다.");
			System.out.println("----------------------------------------------");
		}
		else if(Ds.getHp()>0)
		{
	...
	public void huntAm(Archmage Am)
	{
		...
		if(atk<=Am.getDef())
		{
			System.out.println("벰파이어는 대현자의 방어력이 높아 데미지를 못입혔습니다.");
			System.out.println("----------------------------------------------");
		}
		else if(Am.getHp()>0)
		{
