...
public class DoubleBufferringEx extends Frame implements
KeyListener, Runnable {
	...
	public void update(Graphics g) {
		...
		bufferGraphics.drawImage(image, x, y, x+50, y+50, 
				sel*50, 0, sel*50+50, 50, this);
		paint(g);
	}
