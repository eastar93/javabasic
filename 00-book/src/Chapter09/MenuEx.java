...
public class MenuEx extends Frame {
	...
	public MenuEx() {
		...
		mnucolor.add(mnucolor);
		
		CheckboxMenuItem mnublack = 
				new CheckboxMenuItem("검정색", true);
		CheckboxMenuItem mnured = 
				new CheckboxMenuItem("빨간색");
		CheckboxMenuItem mnublue =
				new CheckboxMenuItem("파란색");
