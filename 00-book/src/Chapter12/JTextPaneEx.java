...
public class JTextPaneEx extends JFrame {
	...
	ImageIcon pigIcon = new ImageIcon("file:///E:/신동규/eastar93/Eclipse%20Java/Workspace/javabasic/00-book/src/Chapter12/Pig.gif");			
	if(pigIcon != null) {
		StyleConstants.setIcon(s, pigIcon);
	}
		s = sdoc.addStyle("button", regular);
	StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
	ImageIcon soundIcon = new ImageIcon("file:///E:/신동규/eastar93/Eclipse%20Java/Workspace/javabasic/00-book/src/Chapter12/sound.gif");
